        ...
        if ($this->debug) {
            try {
                ...
                foreach ($exception->toArray() as $position => $e) {
                    ...
                    $content .= sprintf("%d/%d\r\n%s\r\n%s", $ind, $total, $class, $message);
                    foreach ($e['trace'] as $trace) {
                        $content .= "\r\n";
                        if ($trace['function']) {
                            $content .= sprintf('at %s %s %s', $this->formatClass($trace['class']), $trace['type'], $trace['function'], $this->formatArgs($trace['args']));
                        }
